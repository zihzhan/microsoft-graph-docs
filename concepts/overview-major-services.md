...
| Profile (preview) | Azure AD, Outlook, SharePoint and more | Aggregates and surfaces rich information about a user. This data helps others contextualize the people areound them in their organization or life.  | [Social and workplace intelligence in Microsoft Graph](social-intel-concept-overview.md) |
