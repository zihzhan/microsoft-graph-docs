...
| **Change type** | **Version** | **Description**                          |
| :-------------- | :---------- | :--------------------------------------- |
| Change          | Beta        | Changed roleMemberInfo property type to [identity](../api-reference/v1.0/resources/identity) for [scopedRoleMembership](../api-reference/beta/resources/scopedrolemembership.md) entity |
...
| **Change type** | **Version**   | **Description**                          |
| :-------------- | :------------ | :--------------------------------------- |
| Addition        | v1.0          | New resource [schemaExtension](../api-reference/v1.0/resources/schemaextension) and CRUD methods to manage extension definitions for the following resources: [contact](../api-reference/v1.0/resources/contact), [device](../api-reference/v1.0/resources/device), [event](../api-reference/v1.0/resources/event), [group](../api-reference/v1.0/resources/group), [message](../api-reference/v1.0/resources/message), [organization](../api-reference/v1.0/resources/organization), [post](../api-reference/v1.0/resources/post), [user](../api-reference/v1.0/resources/user). Note that support for [administrativeUnit](../api-reference/beta/resources/administrativeunit.md) is still limited to the beta version as before. |
