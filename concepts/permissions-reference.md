...
Group permissions are used to control access to many [Microsoft Teams](/graph/api/resources/teams-api-overview) resources and APIs. Personal Microsoft accounts are not supported. For more details, see [Microsoft Teams permissions](#microsoft-teams-permissions).
...
|   Permission    |  Display String   |  Description | Admin Consent Required |
|:----------------|:------------------|:-------------|:-----------------------|
|ChatMessage.PatchPolicyViolation.All    | |Allows the app to update a chat message.| |
|ChannelMessage.UpdatePolicyViolation.All| |Allows the app to update a channel message.| |

### Remarks

Many Microsoft Teams resources and APIs use [Group permissions](#group-permissions).
