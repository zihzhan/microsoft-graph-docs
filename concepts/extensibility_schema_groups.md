...
- [List schemaExtensions](/graph/api/api/schemaextension_list?view=graph-rest-1.0)
- [Create schemaExtension](/graph/api/api/schemaextension_post_schemaextensions?view=graph-rest-1.0)
- [Get schemaExtension](/graph/api/api/schemaextension_get?view=graph-rest-1.0)
- [Update schemaExtension](/graph/api/api/schemaextension_update?view=graph-rest-1.0)
- [Delete schemaExtension](/graph/api/api/schemaextension_delete?view=graph-rest-1.0)
