...
Let's walk through the steps for an example [DriveItem Copy](/graph/api/api/driveitem_copy?view=graph-rest-beta) scenario.
...
| **Resource** | **API** |
|:------ | :------ |
| DriveItem | [Copy](/graph/api/api/driveitem_copy?view=graph-rest-beta) |
