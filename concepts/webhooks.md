...
- [Get subscription](/graph/api/api/subscription_get?view=graph-rest-1.0)
- [Create subscription](/graph/api/api/subscription_post_subscriptions?view=graph-rest-1.0)
