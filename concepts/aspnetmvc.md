...
The redirect URI is the URL of the project that you registered. The requested [permission scopes](permission-scopes.md) allow the app to get user profile information and send an email.
