...
|[List all teams](../api/team-list-all-teams.md) | [group](group.md) collection | List all groups that have teams. |
...
|[Add app to team](../api/teamsappinstallation-add.md) | [teamsApp](teamsapp.md) | Adds (installs) an app to a team.|
