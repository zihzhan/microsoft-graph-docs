...
|[refreshDeviceComplianceReportSummarization action](../api/intune-deviceconfig-devicecompliancepolicy-refreshdevicecompliancereportsummarization.md)|None|Not yet documented|
