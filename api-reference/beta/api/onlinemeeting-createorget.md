...
| participants     | [meetingParticipants](../resources/meetingparticipants.md)          | The participants associated with the online meeting.  This includes the organizer and the attendees. The organizer is only supported for the on behalf of scenario, it is not supported now. |
...
```http
POST https://graph.microsoft.com/v1.0/users('{id}')/onlineMeetings/createOrGet
