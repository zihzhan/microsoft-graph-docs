...
If successful, this method returns a `200 OK` response code and collection of [workbookChartPoints](../resources/workbookchartpoint.md) objects in the response body.
## Example
##### Request
