...
this [get event message example](../api/eventmessage-get.md#example-2-get-the-event-associated-with-an-event-message). The app can also respond to the event on behalf of the attendee programmatically, by [accepting](../api/event-accept.md), [tentatively accepting](../api/event-tentativelyaccept.md), or [declining](../api/event-decline.md) the event.
