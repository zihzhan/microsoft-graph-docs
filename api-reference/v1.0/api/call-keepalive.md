...
Make a request to this API every 15 minutes to ensure that an ongoing call stays alive. A call that does not receive this request within the time interval is considered inactive and will subsequently end.
